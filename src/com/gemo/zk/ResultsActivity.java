...
import com.gemo.zk.core.Search;
import com.gemo.zk.utils.AccountData;
import com.gemo.zk.utils.AddContact;
...
//					mAdapter.notifyDataSetChanged();
	...
	private void initSearch() {
		...
		if(mResCount == 0) {
			Toast.makeText(this, getString(R.string.noresult2), Toast.LENGTH_LONG);
			return;
		} else	if(mResCount > 1) {
			String tmpCurrPage = Integer.toString(mCurrentPage + 1);
			mPageCountView.setText(tmpCurrPage + "/" + mResCount);
